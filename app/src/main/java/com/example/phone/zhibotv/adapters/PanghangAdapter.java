 ...
 */
public class PanghangAdapter extends BaseAdapter {
    private final LayoutInflater inflate;
    private List<Paihang.RankingBean.WeekBean> data;
    private Context context;
    public PanghangAdapter(Context context, List<Paihang.RankingBean.WeekBean> data) {
    ...
    public  void  updataRes(List<Paihang.RankingBean.WeekBean> data){
        if (data!=null) {
            this.data.clear();
    ...
    @Override
    public Paihang.RankingBean.WeekBean getItem(int position) {
